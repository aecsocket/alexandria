...
/**
 * Allows scheduling tasks to run in the future, automatically handling platform-specific task registration.
 */
interface Scheduling {
     ...
     *
     * If the entity is not [Entity.isValid] before the given task is run, [onRetire] is called. Therefore,
     * it is guaranteed that [entity] is [Entity.isValid] when tasks are run.
     */
