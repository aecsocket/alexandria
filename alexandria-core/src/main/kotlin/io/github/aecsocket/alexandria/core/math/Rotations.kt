...
fun Vec3f.toQuat(order: EulerOrder): Quat {
...
fun Mat3f.toEuler(order: EulerOrder): Vec3f {
    return when (order) {
        EulerOrder.XYZ -> {
...
fun Quat.toEuler(order: EulerOrder): Vec3f {
    return toMatrix().toEuler(order)
}
