...
typealias CommandManager = PaperCommandManager<CommandSender>
...
open class AlexandriaCommand(
    open val plugin: AlexandriaPlugin,
) {
    val rootName = plugin.manifest.chatName
    protected val manager = CommandManager(
        plugin,
    ...
    protected fun handle(
        ...
        handler: (CommandContext<CommandSender>, CommandSender, I18N<Component>) -> Unit
    ) {
    ...
    fun about(ctx: CommandContext<CommandSender>, sender: CommandSender, i18n: I18N<Component>) {
    ...
    fun reload(ctx: CommandContext<CommandSender>, sender: CommandSender, i18n: I18N<Component>) {
