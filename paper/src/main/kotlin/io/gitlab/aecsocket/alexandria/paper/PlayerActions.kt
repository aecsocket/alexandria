...
import io.gitlab.aecsocket.alexandria.core.BarRenderer
import io.gitlab.aecsocket.alexandria.core.Spinner
...
class PlayerActions internal constructor(
    ...
    data class Settings(
        ...
        val bar: io.gitlab.aecsocket.alexandria.core.BarRenderer = io.gitlab.aecsocket.alexandria.core.BarRenderer(
            0,
            ""
        )
    )
