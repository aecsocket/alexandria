package com.github.aecsocket.alexandria.core.command
...
import com.github.aecsocket.alexandria.core.serializer.WDuration
import com.github.aecsocket.alexandria.core.serializer.wrap
import java.util.*
import kotlin.time.Duration

class DurationFormatExcecption(
    ...
    override fun parse(
        ...
        return inputQueue.peek()?.let { input ->
            ...
            try {
                ...
                ArgumentParseResult.failure(DurationFormatExcecption(
